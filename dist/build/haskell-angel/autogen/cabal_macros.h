...
/* package adventure-game-0.1.0.0 */
#ifndef VERSION_adventure_game
#define VERSION_adventure_game "0.1.0.0"
#endif /* VERSION_adventure_game */
#ifndef MIN_VERSION_adventure_game
#define MIN_VERSION_adventure_game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_adventure_game */
...
#define CURRENT_COMPONENT_ID "adventure-game-0.1.0.0-AoovktCzTpIFxcQU1DCLVh-haskell-angel"
